...
This project implements an intelligent agent that monitors system processes
and automatically manages applications that consume excessive CPU or memory.

The system was developed using the SPADE agent framework and the psutil
...
All system events and agent actions are recorded in:
